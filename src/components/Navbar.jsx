...
import { LayoutDashboard, Calendar, BarChart3, ShieldCheck, Lock, PlusCircle, History, BookOpen, User, LogIn, LogOut } from 'lucide-react';
            ...
            {user ? (
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                ...
                <button
                  ...
                  style={{ fontSize: '11px', padding: '6px 8px', color: '#f87171', borderColor: 'rgba(239, 68, 68, 0.3)' }}
